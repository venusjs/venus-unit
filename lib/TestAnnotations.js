 ...
 * @param {string} basePath Directory of source file
 */
function TestAnnotations(basePath, test) {
 ...
 */
TestAnnotations.prototype.parseStringAnnotation = function (annotationName, annotations) {
  return Object
    .keys(annotations)
 ...
 */
TestAnnotations.prototype.reduceStringArrayValue = function (values, value) {
